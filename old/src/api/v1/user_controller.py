...
from old.src.domain.auth.auth_service import CurrentUser
from old.src.app.dependencies.services import IUserService
from old.src.domain.user.user_dto import (
    CreateUserDTO,
    GetUserDTO,
    GetUserListDTO,
    UpdateUserDTO,
