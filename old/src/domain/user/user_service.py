from old.src.app.dependencies.repositories import IEmailRepository
from old.src.app.dependencies.repositories import IUserRepository
from old.src.domain.user.user_dto import CreateUserDTO, UpdateUserDTO, UpdatePasswordDTO
from old.src.domain.user.user_entity import UserEntity
from old.src.domain.email.email_dto import CreateEmailCodeDTO
